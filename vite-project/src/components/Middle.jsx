...
//     axios.get('https://senior-connect-backend.onrender.com/api/auth/seniors')
...
//     try {
//       const res = await axios.get(`https://senior-connect-backend.onrender.com/api/seniors/search?collegeName=${query}`);
//       setSeniors(res.data);
//     } catch (err) {
