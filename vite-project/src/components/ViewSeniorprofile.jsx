...
//       try {
//         const res = await fetch(`https://senior-connect-backend.onrender.com/api/auth/seniors/${seniorId}`);
...
//       try {
//         const res = await fetch("https://senior-connect-backend.onrender.com/api/pending/student", {
//           credentials: "include",
//           headers: {
...
//     try {
//       const res = await fetch("https://senior-connect-backend.onrender.com/api/requests/request", {
//         method: "POST",
//         credentials: "include",
//         headers: {
//           Authorization: `Bearer ${localStorage.getItem("token")}`,
