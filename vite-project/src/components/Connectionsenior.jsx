            ...
            >
              <div className="flex flex-col items-center text-center">
                <img
                  src={session.student?.profilePicture || '/profile.svg'}
                  alt={session.student?.name || 'Student'}
                  className="w-24 h-24 rounded-full object-cover border-4 border-white shadow-md ring-4 ring-[#76ABAE] mb-4"
                  onError={(e) => {
                    e.currentTarget.onerror = null;
                    e.currentTarget.src = '/profile.svg';
                  }}
                ...
                <h2 className="text-lg font-bold mb-1">{session.student?.name}</h2>
                <p className="text-sm text-gray-500 mb-3 break-words">{session.student?.email}</p>
                  ...
                  <>
                    <div className="w-full mb-3">
                      <DatePicker
                        ...
                        dateFormat="MMM d, yyyy h:mm aa"
                        placeholderText="Select date & time"
                        className="w-full px-3 py-2 text-sm bg-white text-black rounded-md border border-gray-300 shadow focus:outline-none focus:ring-2 focus:ring-[#76ABAE] cursor-pointer"
                      />
                    </div>
